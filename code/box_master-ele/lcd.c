...
/*****驱动io口定义******/
#define CS_H PE_ODR_ODR5=1      //Pe5 CS
#define CS_L PE_ODR_ODR5=0
#define SID_H PC_ODR_ODR6=1     //Pc6 SID
#define SID_L PC_ODR_ODR6=0
#define SCLK_H PC_ODR_ODR5=1   //Pc5 SCLK
#define SCLK_L PC_ODR_ODR5=0
